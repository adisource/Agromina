...
<head>
    ...
    <title>cerita_dan_kegiatan</title>
                    ...
                    <div class="uk-grid-medium uk-child-width-1-1" uk-grid>
                        <div class="uk-text-center">
                            <ul class="uk-breadcrumb uk-flex-center uk-margin-remove">
                                ...
                                <li><span>cerita_dan_kegiatan</span></li>
                            </ul>
                            <h1 class="uk-margin-small-top uk-margin-remove-bottom">cerita_dan_kegiatan</h1>
                        </div>
                        <div>
                                    ...
                                    <section class="uk-card uk-card-default uk-card-small"
                                        ...
                                        <nav>
                                            <ul class="uk-nav uk-nav-default tm-nav">
                                                ...
                                                <li class="uk-active"><a href="cerita_dan_kegiatan.php">cerita_dan_kegiatan</a></li>
                                                <li><a href="news.php">News</a></li>
                                                <li><a href="faq.php">FAQ</a></li>
