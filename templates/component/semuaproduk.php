                                                            ...
                                                            <article class="tm-product-card">
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            class="tm-media-box" href="detailproduk.php">
                                                                            ...
                                                                            <figure class="tm-media-box-wrap"><img
                                                                                    src="images/products/1/BBBB.png"
                                                                                    alt="Terasi Bubuk" />
                                                                            </figure>
                                                                        </a></div>
                                                                </div>
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                ...
                                                                                href="detailproduk.php">Terasi Bubuk</a></h3>
                                                                        <ul
                                                                    ...
                                                                    <div class="tm-product-card-shop">
                                                                        <div class="tm-product-card-prices">
                                                                            <div class="tm-product-card-price">Rp 15.000
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <article class="tm-product-card">
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            <figure class="tm-media-box-wrap"><img
                                                                                    src="images/products/1/terasi-dadu-baru.png"
                                                                                    alt="terasi-dadu-baru" />
                                                                            </figure>
                                                                        </a></div>
                                                                </div>
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                class="uk-link-heading"
                                                                                href="detailproduk.php">Terasi Dadu</a>
                                                                        </h3>
                                                                        <ul
                                                                            class="uk-list uk-text-small tm-product-card-properties">
                                                                            <li><span class="uk-text-muted">Diagonal
                                                            ...
                                                            <article class="tm-product-card">
                                                                ...
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                class="uk-link-heading"
                                                                                href="detailproduk.php">Beras Organik</a></h3>
                                                                        <ul
                                                                            class="uk-list uk-text-small tm-product-card-properties">
                                                                            <li><span class="uk-text-muted">Diagonal
                                                            ...
                                                            <article class="tm-product-card">
                                                                ...
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                class="uk-link-heading"
                                                                                href="detailproduk.php">Kripik Cangkang Kepiting</a></h3>
                                                                        <ul
                                                                            class="uk-list uk-text-small tm-product-card-properties">
                                                                            <li><span class="uk-text-muted">Diagonal
                                                            ...
                                                            <article class="tm-product-card">
                                                                ...
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                class="uk-link-heading"
                                                                                href="detailproduk.php">Dell XPS 15
                                                            ...
                                                            <article class="tm-product-card">
                                                                ...
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                class="uk-link-heading"
                                                                                href="detailproduk.php">Apple MacBook Air
                                                            ...
                                                            <article class="tm-product-card">
                                                                ...
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                class="uk-link-heading"
                                                                                href="detailproduk.php">Dell Inspiron
                                                                                5378-2063 (Gray)</a></h3>
                                                                        <ul
                                                                            class="uk-list uk-text-small tm-product-card-properties">
                                                                            <li><span class="uk-text-muted">Diagonal
                                                            ...
                                                            <article class="tm-product-card">
                                                                ...
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                class="uk-link-heading"
                                                                                href="detailproduk.php">Lenovo Yoga
                                                            ...
                                                            <article class="tm-product-card">
                                                                ...
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                class="uk-link-heading"
                                                                                href="detailproduk.php">Lenovo ThinkPad X380
