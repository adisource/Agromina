                                ...
                                <nav class="uk-visible@m">
                                    <ul class="uk-navbar-nav">
                                        ...
                                        <li><a href="cerita_dan_kegiatan.php"><i class="fas fa-newspaper"
                                                ...
                                                & Kegiatan</a></li>
                                        <li><a href="about.php"><i class="fas fa-pencil-alt"></i>About</a></li>
                                                    ...
                                                    <div class="uk-grid-small uk-flex-middle" uk-grid><a
                                                        ...
                                                        <div class="uk-width-expand">
                                                            <h2 class="uk-h4 uk-margin-remove"><a
                                                                    class="uk-link-heading" href="category.php">Laptops
                                                                    &amp; Tablets</a></h2>
                                            ...
                                            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                                                <header class="uk-card-header">
                                                    <div class="uk-grid-small uk-flex-middle" uk-grid><a
                                                        ...
                                                        <div class="uk-width-expand">
                                                            <h2 class="uk-h4 uk-margin-remove"><a
                                                                    class="uk-link-heading" href="category.php">Phones
                                                                    &amp; Gadgets</a></h2>
                                                ...
                                                <div class="uk-card-body">
                                                    <ul class="uk-list">
                                                        ...
                                                        <li><a href="subcategory.php">Charging and batteries</a></li>
                                                        <li><a href="subcategory.php">Accessories</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                                                <header class="uk-card-header">
                                                    <div class="uk-grid-small uk-flex-middle" uk-grid><a
                                                        ...
                                                        <div class="uk-width-expand">
                                                            <h2 class="uk-h4 uk-margin-remove"><a
                                                                    class="uk-link-heading" href="category.php">TV
                                                                    &amp; Video</a></h2>
                                                ...
                                                <div class="uk-card-body">
                                                    <ul class="uk-list">
                                                        ...
                                                        <li><a href="subcategory.php">Satellite &amp; Cable TV</a></li>
                                            ...
                                            <div class="uk-card uk-card-default uk-card-small tm-ignore-container">
                                                <header class="uk-card-header">
                                                    <div class="uk-grid-small uk-flex-middle" uk-grid><a
                                                        ...
                                                        <div class="uk-width-expand">
                                                            <h2 class="uk-h4 uk-margin-remove"><a
                                                                    class="uk-link-heading" href="category.php">Games
                                                                    &amp; Entertainment</a></h2>
                                                ...
                                                <div class="uk-card-body">
                                                    <ul class="uk-list">
                                                        ...
                                                        <li><a href="subcategory.php">Joysticks &amp; gamepads</a></li>
                                                        <li><a href="subcategory.php">Accessories</a></li>
                                                    </ul>
                                                </div>
                                            </div>
