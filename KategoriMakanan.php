                    ...
                    <div class="uk-navbar-left"><button class="uk-navbar-toggle uk-hidden@m"
                        ...
                        <nav class="uk-visible@m">
                            <ul class="uk-navbar-nav">
                                ...
                                <li><a href="cerita_dan_kegiatan.php"><i class="fas fa-newspaper"
                ...
                <div class="uk-container">
                    <div class="uk-grid-medium uk-child-width-1-1" uk-grid>
                        <div class="uk-text-center">
                            ...
                            <h1 class="uk-margin-small-top uk-margin-remove-bottom">Makanan</h1>
                                                                ...
                                                                <div class="tm-product-card-media">
                                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                                            ...
                                                                            <figure class="tm-media-box-wrap"><img
                                                                                    src="images/products/1/kripik.png"
                                                                                    alt="beras" />
                                                                            </figure>
                                                                        </a></div>
                                                                </div>
                                                                <div class="tm-product-card-body">
                                                                    <div class="tm-product-card-info">
                                                                        ...
                                                                        <h3 class="tm-product-card-title"><a
                                                                                ...
                                                                                href="product.php">Kerupuk cangkang
                                                                                Kepiting</a>
                                                                        </h3>
                                                                        <ul
                                                                            class="uk-list uk-text-small tm-product-card-properties">
                                                                            <p>Kerupuk adalah makanan pendamping yang
                                                                                biasanya disajikan sebagai pelengkap
                                                                                makan seperti halnya kecap. Hampir di
                                                                                seluruh dunia kenal dengan makanan khas
                                                                                yang satu ini karena kemudahannya di
                                                                                temukan. Namun, kerupuk yang satu ini
                                                                                tidak hanya sebagai makanan pendamping
                                                                                tapi dapat memberi kebaikan untuk tubuh
                                                                                karena kandungan senyawa yang di
                                                                                dalamnya dapat mencegah sel kanker.</p>
                                                                        </ul>
                                                                    </div>
                                                                    <div class="tm-product-card-shop">
                                                                        <div class="tm-product-card-prices">
                                                                            <div class="tm-product-card-price">Rp
                                                                                15.000
                                                                            </div>
                                                                        </div>
